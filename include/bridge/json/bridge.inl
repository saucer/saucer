...
namespace saucer
{
    ...
    template <typename func_t> void json_bridge::expose(const std::string &name, const func_t &function)
    {
    ...
    std::shared_ptr<promise<rtn_t>> json_bridge::call(const std::string &function_name, const args_t &...args)
    {
